        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    las_name = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TipoId = table.Column<byte[]>(nullable: false),
                    name = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FacturaId = table.Column<byte[]>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Factura_Client_ClientId",
                        column: x => x.ClientId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ServiceId = table.Column<byte[]>(nullable: false),
                    name = table.Column<string>(nullable: true),
                    description = table.Column<string>(nullable: true),
                    precio = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    comicion = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    TipoId = table.Column<byte[]>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    List_itemsId = table.Column<byte[]>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_List_Items", x => x.List_itemsId);
                    table.ForeignKey(
                        name: "FK_List_Items_Factura_FacturaId",
                        column: x => x.FacturaId,
                        principalTable: "Factura",
                        principalColumn: "FacturaId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_List_Items_Service_ServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NumberId = table.Column<byte[]>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Number_Service_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "Service",
                        principalColumn: "ServiceId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientNumber", x => new { x.ClientId, x.NumberId });
                    table.ForeignKey(
                        name: "FK_ClientNumber_Client_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Client",
                        principalColumn: "ClientId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClientNumber_Number_NumberId",
                        column: x => x.NumberId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientNumber_NumberId",
                table: "ClientNumber",
                column: "NumberId");

            migrationBuilder.CreateIndex(
                name: "IX_Factura_ClientId",
                table: "Factura",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_List_Items_FacturaId",
                table: "List_Items",
                column: "FacturaId");

            migrationBuilder.CreateIndex(
                name: "IX_List_Items_ServiceId",
                table: "List_Items",
                column: "ServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_Number_ServiceId",
                table: "Number",
                column: "ServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_Service_TipoId",
                table: "Service",
                column: "TipoId");
        }
